...
<body>
    <form id="form1" runat="server">
        <div class="ana_countainer">
            <div class="toplu_hakkimizda">
         <h2 class="hakkimizda_baslik">Hakkımızda</h2>
    <p class="hakkimizda_paragraf">
...
Projemizdeki temel hedefimiz, kullanıcılarımıza zaman yönetiminde yardımcı olacak güçlü bir araç sunarken, hem görsel açıdan zengin hem de kullanılabilirliği yüksek bir deneyim yaratmaktır.
    ...
    <div class="alt_kapsayici">
        <div class="ayri_hakkimizda">
    <h3 class="ayri_baslik">Ensar Ali Öztürk</h3>

    <p class="ayri_paragraf">
    ...
    <div class="buton_alani">
        <!-- FontAwesome'dan LinkedIn ikonu -->
       
<a href="www.linkedin.com/in/ensar-ali-öztürk-44a04b346" target="_blank">
    <i class="fab fa-linkedin"></i>
</a>

<!-- FontAwesome'dan GitHub ikonu -->
<a href="https://github.com/ensar0zturk" target="_blank">
    <i class="fab fa-github"></i>
</a>

<!-- FontAwesome'dan Email ikonu -->
<a href="mailto:ensaraliozturk456@gmail.com" title="ensaraliozturk456@gmail.com">
    <i class="fas fa-envelope"></i>
</a>
        <a href="https://www.instagram.com/ensar0zturk_/" target="_blank">
...
<div class="ayri_hakkimizda">
    <h3 class="ayri_baslik">Yusuf Tezgören</h3>
    <p class="ayri_paragraf">
Bu projeyi ekip olarak geliştirirken hem ASP.NET Web Forms pratiği yapma hem de gerçek dünyaya yönelik bir uygulama geliştirme fırsatı bulduk. Süreç boyunca teknik ve problem çözme becerilerimi geliştirdim. Benim katkı sağladığım başlıca alanlar; tema renklerinin dinamik değiştirilmesini sağlayan CSS düzenlemeleri, C# tarafında Pomodoro süresinin bitiminde otomatik olarak molaya geçmesini ve mola süresi sonunda durmasını sağlayan zamanlayıcı mantığı oldu. Ayrıca iframe ile Spotify çalma listesi ve web tabanlı oyun gömme işlemlerini ben gerçekleştirdim. Bu süreçte takım çalışması ve bireysel sorumluluk alma konularında önemli deneyimler kazandım.    </p>
    <div class="buton_alani">
                <!-- FontAwesome'dan LinkedIn ikonu -->
<a href="https://www.linkedin.com/in/yusuf-tezgoren-226179331/" target="_blank">
    <i class="fab fa-linkedin"></i>
</a>

<!-- FontAwesome'dan GitHub ikonu -->
<a href="https://github.com/tezgoren" target="_blank">
    <i class="fab fa-github"></i>
</a>

<!-- FontAwesome'dan Email ikonu -->
<a href="mailto:tezgoren207@gmail.com" title="tezgoren207@gmail.com">
    <i class="fas fa-envelope"></i>
</a>
    </div>
</div>
<div class="ayri_hakkimizda">
    <h3 class="ayri_baslik">Yusuf Uçar</h3>
    <p class="ayri_paragraf">
        Web geliştirme alanına özellikle frontend tarafına ilgi duyuyorum ve bu alanda kendimi geliştirmek için çeşitli küçük projeler üzerinde çalıştım. Şu anda Flutter ile mobil uygulama geliştirmeye odaklanarak kullanıcı dostu ve modern arayüzler oluşturma konusunda deneyim kazanıyorum. Öğrenmeye açık yapım ve sürekli gelişim hedefimle yazılım dünyasında sağlam adımlarla ilerliyorum.

    </p>
    <div class="buton_alani">
        <a href="https://www.linkedin.com/in/00yusufcr" target="_blank">
    <i class="fab fa-linkedin"></i>
</a>

<!-- FontAwesome'dan GitHub ikonu -->
<a href="https://github.com/zynoxus" target="_blank">
    <i class="fab fa-github"></i>
</a>

<!-- FontAwesome'dan Email ikonu -->
<a href="mailto:00yusufcr.uni@gmail.com " title="00yusufcr.uni@gmail.com ">
    <i class="fas fa-envelope"></i>
</a>
    </div>

</div>
                <asp:Panel ID="pnlFeedback" runat="server" CssClass="feedback-container">
                    <h2>Geri Bildirim</h2>
    <div class="stars">
    ...
    <div class="feedback-text">
        <asp:TextBox ID="txtFeedback" runat="server" TextMode="MultiLine" Rows="10" Columns="30" Placeholder="Görüşünüzü buraya yazabilirsiniz..." CssClass="textbox-feedback" />
    </div>

    <asp:Button ID="btnSendFeedback" runat="server" Text="Gönder" CssClass="btn-feedback" OnClick="btnSendFeedback_Click" />
